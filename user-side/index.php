...
<!-- Reste du contenu de la page index.php -->
...
<header style="background-color: #ff8080;">
    <h1 style="color: white;">Exquisite Jewellery</h1>
</header>
...
<!-- Jumbotron section -->
   ...
   <!-- ... (head section and styles) ... -->

<!-- Jumbotron section -->
<section class="jumbotron">
    <div class="container">
        <h2 class="display-4">Explore Our Exquisite Jewellery</h2>
...
<!-- Footer section -->
<footer>
    <p>&copy; 2023 Exquisite Jewellery. All rights reserved.</p>
</footer>
